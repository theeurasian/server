...
import eurasian.domain.news.ActorNewsManager.{GetAeRss, GetByRss, GetCnRss, GetDeRss, GetEnRss, GetEsRss, GetFrRss, GetIdRss, GetInRss, GetIrRss, GetKoRss, GetKzRss, GetMnRss, GetPkRss, GetPtRss, GetQaRss, GetRuRss, GetVnRss}
  ...
  override def receive: Receive = {
    case cmd:WSCmd =>
      cmd.name match {
        ...
        case "getPtRss" =>
          ActorManager.newsManager ! GetPtRss(cmd)
        case "getWeather" =>
